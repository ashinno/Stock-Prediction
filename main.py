...
if choice == "Home":
    ...
    st.subheader("What is the benefit of using this app")
    st.write("""The app provides an easy-to-use interface for predicting stock prices using the Prophet algorithm. It allows the user to select datasets for prediction,
             ...
             By using this app, users can quickly and easily analyze stock data and make informed investment decisions.
             They can also experiment with different combinations of technical indicators to see how they affect the predicted stock prices.
              Overall, this app can save users time and effort in analyzing stock data and help them make more informed investment decisions.""")
    ...
    st.write(
        "4. Open a terminal window and navigate to the directory where the app.py file is located.")
    st.write(
        "5. Run the app by typing streamlit run app.py in the terminal and pressing Enter.")
    ...
    st.write("8. If you select *Home*, you will see a welcome message and instructions for selecting datasets and date range for analysis.")
    st.write("9. If you select *Stock Prices*, you will see a multiselect option for selecting datasets, date inputs for start and end dates,\
              a slider for selecting the number of years for prediction, and checkboxes for adding technical indicators to the chart.")
    st.write("10. Select the datasets you want to analyze by clicking on the checkboxes next to the ticker symbols.")
    st.write(
